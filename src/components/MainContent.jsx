...
import im11 from '../img/evening.svg'
import im12 from '../img/morning.svg'
import im13 from '../img/fajr.png'
import im14 from '../img/zuhr.png'
import im15 from '../img/asr.png'
import im16 from '../img/magrib.png'
import im17 from '../img/isha.png'
...
<div className='col-lg-4'>
  ...
  <img src={im11} className='w-100' alt="" />
...
<div className='col-lg-4 '>
  <Link to={"/Evening"}>
  <div className='position-relative'>
  <img src={im12} className='  w-100' alt="" />
  <div className='position-absolute  kl'>
  <h3>اذكار المساء</h3>
  </div>
</div> 
...
<h3>{remainingTime}</h3>
   ...
   <div className="card overflow-hidden" >
     <img src={im13}className="card-img-top p-3 " alt="..." />
   ...
   <div className='col-md-3  col-sm-6'>
   <div className="card" >
     <img src={im14} className="card-img-top p-3" alt="..." />
     <div className="card-body">
   ...
   <div className='col-md-3 col-sm-6'>
   <div className="card" >
     <img src={im15} className="card-img-top p-3" alt="..." />
     <div className="card-body">
   ...
   <div className='col-md-3  col-sm-6 '>
   <div className="card" >
     <img src={im16} className="card-img-top p-3" alt="..." />
     <div className="card-body">
   ...
   <div className="card shadow-lg  rounded " >
     <img src={im17} className="card-img-top p-3" alt="..." />
